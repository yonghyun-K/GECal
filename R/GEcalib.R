...
#' In this case, the corresponding \code{const} for \code{g(dweight)} is set to \code{NA}, and \code{GECalib} performs joint optimization over
...
#' Examples of \eqn{K(\alpha)} includes \eqn{K(\alpha) = \alpha}(\code{K_alpha == NULL}), and 
